...
CREATE TABLE `prontuario` (
  ...
  `receituario` text CHARACTER SET utf16 COLLATE utf16_swedish_ci,
  `exames` text CHARACTER SET utf16 COLLATE utf16_swedish_ci,
  `observacoes` varchar(255) CHARACTER SET utf16 COLLATE utf16_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
